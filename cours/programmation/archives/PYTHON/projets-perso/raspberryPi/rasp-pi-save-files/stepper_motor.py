...
class Stepmotor:
    ...
    def __init__(self):
        ...
        # Broches du Raspberry utilisées
        self.pin_A = 29
        self.pin_B = 31
        self.pin_C = 33
        self.pin_D = 35
    ...
    def close(self):
        # Libérer l'utilisation pour d'autres applications
        GPIO.cleanup()
    ...
    def turnDegrees(self, count):
        # Tourner de 'n' degrés (imprécis pour les petites valeurs)
